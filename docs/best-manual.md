...
**💬 サポートについて**  
マニュアルに記載の有無に関わらず、疑問点、困りごと、要望などどんなことでもDiscordにてスタッフまでお問い合わせください。
...
1. **既存台本の改善**: 自分で作成した台本の冒頭の訴求力を高めたい
2. **新規作成**: 企画案を元に、ゼロから冒頭を作成したい
3. **パターン比較**: 複数の訴求方法を比較検討したい
...
各フェーズで内容を確認し、チャットで承認または修正指示を出します。
...
2. **入力**: 長尺台本の全文を貼り付け
3. **分析確認**: AIのペルソナ分析を確認し、OKなら「OK」と送信
...
<details markdown="1">
<summary>▶ 方法3：AI編集（全体修正依頼）</summary>

台本全体を見ながら、チャット入力欄から修正依頼を出す方法です。部分選択とは異なり、台本全体のコンテキストを考慮した修正が可能です。

##### **使い方**

1. ドキュメント画面下部の**チャット入力欄**に修正指示を入力
2. 画面右下の「**台本の修正依頼**」ボタンをクリック
3. AIが台本全体を考慮して修正案を提示
4. 「変更点を表示」で差分を確認し、「承認」または「却下」を選択

##### **部分選択との使い分け**

| 方法 | 適している場面 |
|------|--------------|
| **部分選択**（方法2） | 特定の箇所だけを修正したい |
| **全体修正依頼**（方法3） | 台本全体の流れを見て修正したい<br>複数箇所に跨る修正をしたい |

> 💡 **Tips**: 「冒頭部分のトーンを全体的にカジュアルにして」など、台本全体に関わる修正指示に最適です。

</details>

<details markdown="1">
<summary>▶ 方法4：バージョン管理</summary>
...
- 企画案作成AI や台本全文作成AI で、毎回チャットで知識を伝える

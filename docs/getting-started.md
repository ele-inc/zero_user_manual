...
![トップ画面のバナー](images/gs-profile-banner.png)

![サイドバーのマイページ](images/gs-mypage-sidebar.png)
...
![入力方式の選択](images/gs-method-select.png)

![音声会話の選択](images/gs-voice-select.png)
...
![コピペ方式の選択](images/gs-copypaste-select.png)

![テキスト入力画面](images/gs-copypaste-input.png)

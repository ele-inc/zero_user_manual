...
**2.** お客様情報（メールアドレス、電話番号）を入力 →「**次へ**」→ カード情報を入力 →「**送信**」
...
定期課金のキャンセルは、マイページの「プラン管理」画面から行えます。

**1.** 左サイドバーの「**プラン管理**」をクリック、または以下のURLからプラン管理画面を開きます。

[https://youtube-content-gen.vercel.app/mypage/subscription](https://youtube-content-gen.vercel.app/mypage/subscription)

**2.** 画面下部の「**プランをキャンセルする**」ボタンをクリックします。

![プランをキャンセルするボタンの場所](images/plan-cancel.png)

### 補足

- キャンセル後も「**台本1本添削**」のサービスはご利用いただけます
- ご利用再開はいつでも可能です。LINEメッセージまたはDiscordにてご連絡ください
